        ...
        <div className="min-h-screen flex flex-col bg-[#F9FAFB]">
            ...
            <main className="flex-1 flex flex-col">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <BlurFade delay={0.4} duration={0.8}>
                            <div className="bg-white rounded-2xl p-8 border border-border">
                                <div className="w-12 h-12 bg-[#0F172A]/10 rounded-xl flex items-center justify-center mb-4">
                                    <Globe className="w-6 h-6 text-[#0F172A]" />
                                </div>
                                <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-3`}>100% Remote-First</h3>
                        ...
                        <BlurFade delay={0.5} duration={0.8}>
                            <div className="bg-white rounded-2xl p-8 border border-border">
                                ...
                                <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-3`}>Modern Tech Stack</h3>
                                <p className="text-text-muted">
                        ...
                        <BlurFade delay={0.6} duration={0.8}>
                            <div className="bg-white rounded-2xl p-8 border border-border">
                                ...
                                <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-3`}>Small, Fast-Moving Team</h3>
                                <p className="text-text-muted">
                        ...
                        <BlurFade delay={0.7} duration={0.8}>
                            <div className="bg-white rounded-2xl p-8 border border-border">
                                ...
                                <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-3`}>Ownership & Autonomy</h3>
                                <p className="text-text-muted">
                        ...
                        <BlurFade delay={0.8} duration={0.8}>
                            <div className="bg-white rounded-2xl p-8 border border-border">
                                ...
                                <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-3`}>Real Impact</h3>
                                <p className="text-text-muted">
                        ...
                        <BlurFade delay={0.9} duration={0.8}>
                            <div className="bg-white rounded-2xl p-8 border border-border">
                                ...
                                <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-3`}>Competitive Compensation</h3>
                                <p className="text-text-muted">
                ...
                <section className="max-w-4xl mx-auto px-6 py-16">
                    ...
                    <div className="space-y-4">
                        ...
                        <BlurFade delay={0.4} duration={0.8}>
                            <div className="bg-white rounded-2xl p-6 border border-border flex items-center justify-between">
                                <div>
                                    <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-1`}>Software Engineer — Backend</h3>
                        ...
                        <BlurFade delay={0.5} duration={0.8}>
                            <div className="bg-white rounded-2xl p-6 border border-border flex items-center justify-between">
                                <div>
                                    <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-1`}>Product Designer — UX/UI</h3>
                        ...
                        <BlurFade delay={0.6} duration={0.8}>
                            <div className="bg-white rounded-2xl p-6 border border-border flex items-center justify-between">
                                <div>
                                    <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-1`}>Customer Success Specialist</h3>
                        ...
                        <BlurFade delay={0.7} duration={0.8}>
                            <div className="bg-white rounded-2xl p-6 border border-border flex items-center justify-between">
                                <div>
                                    <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-1`}>Data Analyst — Refund Optimization</h3>
                        ...
                        <BlurFade delay={0.8} duration={0.8}>
                            <div className="bg-white rounded-2xl p-6 border border-border flex items-center justify-between">
                                <div>
                                    <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-1`}>Fraud & Compliance Specialist</h3>
                    ...
                    <BlurFade delay={0.9} duration={0.8}>
                        <div className="mt-12 bg-gradient-to-br from-[#0F172A]/5 to-white border-2 border-[#0F172A]/20 rounded-3xl p-8 md:p-12 text-center">
                            ...
                            <a href="mailto:careers@pockret.com">
                                <Button size="lg" className="h-14 px-8 rounded-full bg-[#0F172A] hover:bg-[#020617] text-white font-bold text-lg">
                ...
                <section className="max-w-4xl mx-auto px-6 py-16">
                    <BlurFade delay={0.5} duration={0.8}>
                        <div className="bg-white rounded-2xl p-8 border border-border">
                            <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-4`}>About Virtual World LLC</h3>
