                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <BlurFade delay={0.3} duration={0.8}>
                            <div className="bg-white rounded-3xl p-8 border-2 border-border shadow-sm">
                                <div className="w-16 h-16 bg-[#0F172A]/10 rounded-2xl flex items-center justify-center mb-6">
                                    <CheckCircle2 className="w-8 h-8 text-[#0F172A]" />
                                </div>
                                <h3 className={`${ppAgrandirHeading.className} text-2xl font-bold text-foreground mb-4`}>100% Money-Back Guarantee</h3>
                        ...
                        <BlurFade delay={0.4} duration={0.8}>
                            <div className="bg-white rounded-3xl p-8 border-2 border-border shadow-sm">
                                ...
                                <h3 className={`${ppAgrandirHeading.className} text-2xl font-bold text-foreground mb-4`}>Secure & Private</h3>
                                <p className="text-text-muted leading-relaxed">
                        ...
                        <BlurFade delay={0.5} duration={0.8}>
                            <div className="bg-white rounded-3xl p-8 border-2 border-border shadow-sm">
                                ...
                                <h3 className={`${ppAgrandirHeading.className} text-2xl font-bold text-foreground mb-4`}>Instant Access</h3>
                                <p className="text-text-muted leading-relaxed">
                        ...
                        <BlurFade delay={0.6} duration={0.8}>
                            <div className="bg-white rounded-3xl p-8 border-2 border-border shadow-sm">
                                ...
                                <h3 className={`${ppAgrandirHeading.className} text-2xl font-bold text-foreground mb-4`}>Lifetime Updates</h3>
                                <p className="text-text-muted leading-relaxed">
                    ...
                    <div className="space-y-6">
                        <BlurFade delay={0.3} duration={0.8}>
                            <div className="bg-white rounded-2xl p-6 border border-border">
                                <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-3`}>Is this really a one-time payment?</h3>
                        ...
                        <BlurFade delay={0.4} duration={0.8}>
                            <div className="bg-white rounded-2xl p-6 border border-border">
                                <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-3`}>What if I don't find any refunds?</h3>
                                <p className="text-text-muted">
                        ...
                        <BlurFade delay={0.5} duration={0.8}>
                            <div className="bg-white rounded-2xl p-6 border border-border">
                                <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-3`}>How much can I expect to recover?</h3>
                                <p className="text-text-muted">
                        ...
                        <BlurFade delay={0.6} duration={0.8}>
                            <div className="bg-white rounded-2xl p-6 border border-border">
                                <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-3`}>Is my data secure?</h3>
                                <p className="text-text-muted">
                        ...
                        <BlurFade delay={0.7} duration={0.8}>
                            <div className="bg-white rounded-2xl p-6 border border-border">
                                <h3 className={`${ppAgrandirHeading.className} text-xl font-bold text-foreground mb-3`}>Can I use this in my country?</h3>
                                <p className="text-text-muted">
